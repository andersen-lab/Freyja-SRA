...
# Calculate population-weighted abundance for each lineage
...
# Divide by total population to get population-weighted mean abundance
df_agg_weekly['mean_lineage_prevalence'] = df_agg_weekly['pop_weighted_abundance'] / df_agg_weekly['total_population']
df_agg_weekly = df_agg_weekly.drop(columns=['pop_weighted_abundance', 'collection_date', 'week'])
